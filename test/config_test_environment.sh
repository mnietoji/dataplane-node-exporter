...
ovs-vsctl add-port br-phy-0 tap0 -- set interface tap0 type=dpdk options:dpdk-devargs=net_tap0 options:n_rxq=3
ovs-vsctl add-port br-phy-0 tap1 -- set interface tap1 type=dpdk options:dpdk-devargs=net_tap1 options:n_rxq=3
...
ip netns exec ns_0 iperf3 -s -B 10.10.10.10 -p 7575 -D --logfile /tmp/iperf3.txt --forceflush
c sleep 3
